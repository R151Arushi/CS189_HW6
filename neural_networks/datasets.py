...
def initialize_dataset(
    ...
    if name == 'higgs':
        ...
        training_set = np.load('/Users/arushisharma/Desktop/CS189/hw6/hw6_release/code/datasets/iris/iris_test_data.npy')
        training_labels = np.load('/Users/arushisharma/Desktop/CS189/hw6/hw6_release/code/datasets/iris/iris_test_labels.npy')

        validation_set = np.load('/Users/arushisharma/Desktop/CS189/hw6/hw6_release/code/datasets/iris/iris_val_data.npy')
        validation_labels = np.load('/Users/arushisharma/Desktop/CS189/hw6/hw6_release/code/datasets/iris/iris_val_labels.npy')

        test_set = np.load('/Users/arushisharma/Desktop/CS189/hw6/hw6_release/code/datasets/iris/iris_test_data.npy')
        test_labels = np.load('/Users/arushisharma/Desktop/CS189/hw6/hw6_release/code/datasets/iris/iris_test_labels.npy')
